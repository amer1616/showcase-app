...
<header class="flex justify-between">
  ...
  <nav class="flex justify-center">
    ...
    <ul>
      ...
      <li
        aria-current={$page.url.pathname.startsWith("/movies")
          ? "page"
          : undefined}
      >
      ...
      <li
        aria-current={$page.url.pathname.startsWith("/contacts")
          ? "page"
          : undefined}
      >
        <a href="/contacts" data-sveltekit-preload-data>Contacts</a>
      </li>
      <li
