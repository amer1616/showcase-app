...
type LayoutRouteId = RouteId | "/" | "/about" | "/contacts" | "/movies" | "/settings" | "/settings/appearance" | "/settings/profile" | "/shop" | "/shop/[productId]" | null
type LayoutParams = RouteParams & { productId?: string }
