...
<blockquote>
<p><strong>⚠️ This is a pre-release, contains breaking changes and works only with the new PocketBase v0.8+ API!</strong></p>
</blockquote>
...
<div class="highlight"><pre>npm install pocketbase@next --save
</pre></div>
...
<span class="kr">export</span> <span class="nx">async</span> <span class="kd">function</span> <span class="nx">POST</span><span class="p">({</span> <span class="nx">request</span><span class="p">,</span> <span class="nx">locals</span> <span class="p">})</span> <span class="p">{</span>
    ...
    <span class="kr">const</span> <span class="p">{</span> <span class="nx">token</span><span class="p">,</span> <span class="nx">user</span> <span class="p">}</span> <span class="o">=</span> <span class="nx">await</span> <span class="nx">locals</span><span class="p">.</span><span class="nx">pocketbase</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s1">&#39;users&#39;</span><span class="p">).</span><span class="nx">authWithPassword</span><span class="p">(</span><span class="nx">email</span><span class="p">,</span> <span class="nx">password</span><span class="p">);</span>
...
<span class="p">&lt;</span><span class="nt">script</span> <span class="na">setup</span><span class="p">&gt;</span>
  <span class="kr">const</span> <span class="p">{</span> <span class="nx">data</span> <span class="p">}</span> <span class="o">=</span> <span class="nx">await</span> <span class="nx">useAsyncData</span><span class="p">(</span><span class="nx">async</span> <span class="p">(</span><span class="nx">nuxtApp</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
    <span class="kr">const</span> <span class="nx">pb</span> <span class="o">=</span> <span class="nx">nuxtApp</span><span class="p">.</span><span class="nx">$pocketbase</span><span class="p">();</span>

    <span class="c1">// fetch and return all &quot;example&quot; records...</span>
    <span class="k">return</span> <span class="nx">await</span> <span class="nx">pb</span><span class="p">.</span><span class="nx">collection</span><span class="p">(</span><span class="s1">&#39;example&#39;</span><span class="p">).</span><span class="nx">getFullList</span><span class="p">();</span>
  <span class="p">})</span>
<span class="p">&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
</pre></div>
</details>
...
<span class="kr">export</span> <span class="k">default</span> <span class="p">(</span><span class="nx">ctx</span><span class="p">,</span> <span class="nx">inject</span><span class="p">)</span> <span class="o">=&gt;</span> <span class="p">{</span>
  <span class="kr">const</span> <span class="nx">pb</span> <span class="o">=</span> <span class="k">new</span> <span class="nx">PocketBase</span><span class="p">(</span><span class="s1">&#39;http://127.0.0.1:8090&#39;</span><span class="p">);</span>
